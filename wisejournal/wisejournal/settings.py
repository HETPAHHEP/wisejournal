"""
Django settings for wisejournal project.
...
SECRET_KEY = 'django-insecure-qawhf4kggv=^p71mas#z+p)(ymof#o(8=rqk+xt*h$^otp*9p3'
...
WSGI_APPLICATION = 'wisejournal.wsgi.application'
